...
import 'package:rehabbudy/screens/forgot_password_screen/forgot_password_screen.dart';
...
class _BodyState extends State<Body> {
  ...
  Form signUpFormWidget(Size size, BuildContext context) {
    return Form(
      key: _formkey,
      child: SizedBox(
